        ...
        return(
            <Nav.Item className={"navItem"}>
                <Row className={"navItemRow"}>
                    ...
                    <Col md={{span:6}}>
                        <Nav.Link eventKey="first">{this.props.username}</Nav.Link>
                    </Col>
                    <Col md={{span:2,offset:1}}>
                        <Dropdown drop={"down"}>
                            <Dropdown.Toggle variant={"link"} className={"shadow-none"}>
                            </Dropdown.Toggle>
                            <Dropdown.Menu className={"dd"} >
                                <Dropdown.Header>{this.props.username} Permissions</Dropdown.Header>
